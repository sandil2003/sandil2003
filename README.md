...
* **Autonomous Agents:** Engineering self-correcting, multi-agent ecosystems to handle complex, automated workflows.
* **Graphics & Simulation:** Exploring 3D physics, environment rendering, and performance optimization within interactive spaces.
* **Computational Science:** Investigating how parallel processing architectures can accelerate machine learning and complex simulation models.

---

<p align="center">
  <a href="your-link">LinkedIn</a> • <a href="mailto:your-email">Email</a> • <a href="your-link">Portfolio</a>
</p>
